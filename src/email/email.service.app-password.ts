...
/**
 * Alternative Email Service using App Password
 * 
 * CÁCH SỬ DỤNG:
 * 1. Đổi tên file này thành email.service.ts (backup file cũ trước)
 * 2. Tạo App Password trong Gmail:
 *    - Vào https://myaccount.google.com/apppasswords
 *    - Tạo App Password mới
 *    - Copy password (16 ký tự, có dấu cách)
 * 3. Thêm vào .env:
 *    GMAIL_USER=your-email@gmail.com
 *    GMAIL_APP_PASSWORD=xxxx xxxx xxxx xxxx
 *    GMAIL_USER_NAME=Volunteer System
 * 
 * ⚠️ LƯU Ý: App Password kém bảo mật hơn OAuth2, chỉ dùng cho development
 */
...
export class EmailService {
  ...
  private initializeTransporter() {
    try {
      ...
      if (!user || !appPassword) {
        throw new Error(
          'GMAIL_USER and GMAIL_APP_PASSWORD must be set in .env file'
        );
      }
